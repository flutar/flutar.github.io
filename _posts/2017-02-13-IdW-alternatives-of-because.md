---
layout: post
title:  除了 because 还可以用什么表示原因
date:   2017-02-13 12:32:54
categories: 托福写作
tags: 写作句式
...
```
说理在各种写作中是必不可少的，而因果又是说理中不可或缺的。于是我就在下面汇总了 TPO 中常用的表示原因的一些表达，防止大家一个 because 一用到底。这个词没啥不好，但用多了自己也会觉得烦。大家有几个替换就行，不用搞的太多，多了也记不住。记得时候最好以句子为单位来记，效率高一些。
```
...
总体来说，这两次灭绝被认为是陨石撞击或者大规模的火山爆发导致的剧烈的环境变化造成的。
...
独立行会不断增加，是因为剩余价值的产生并非由于国内生产，而是主要来自于国际间的贸易活动。
...
但有证据指出，人类狩猎以及破坏栖息地很可能是当前大规模物种灭绝的原因。
...
很少人直接质疑什么可能让一个教师想变成反思型教师。显然，使教师朝着反思行为努力的最直接的原因是师资培训者认为这是一件很好的事情。 
...
这种情况（贸易是主要支柱）从古至今都是如此，一部分原因是中东地区的地质环境——多为沙石和石灰岩，金属矿藏和其它有用材料很少。古代对黑曜石（一种火山岩，可以用来制作镜子和工具）的需求引发了（中东地区）与北方的亚美尼亚之间的贸易；用作切削工具的玉石从土耳其斯坦购买；而贵重的琉璃青金石是从阿富汗地区进口。

Such anomalies are due to the relative abundance of the "isotopes" or varieties of each element.

出现这种反常现象，主要是因为相对丰富的“同位素”或者各种元素的多样性。 
...
但是因为在周期表中这两个元素之间没有缝隙，由此门捷列夫提出铟的原子质量变为截然不同的一个值，这样就可以将其置于镉和锡之间的空位。
...
冥王星不属于这两类中的任何一个，因为它距地球很远且体积较小，所以目前冥王星的真实形态仍然是个谜。
