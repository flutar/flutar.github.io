...
layout: post
title:  独立写作万能理由之科技
date:   2017-02-15 18:21:54
categories: 托福写作
tags: 写作素材
author: Zhanchao Yu
excerpt: 独立写作最常用的展开素材-科技，及其使用示范
---
...
Firstly, advancement in the `internet` technology makes it possible that `a large wealth of information can be easily obtained online, as a result of which chances are greater for people nowadays to receive an education of higher quality`. Along with the ever-accelerating developments of science and technology come major breakthroughs in various disciplines related to `network technology like computer science and software engineering`, the combination of which has been pushing `internet technology` to a higher level. Scientists have found solutions to many `problems` that used to be considered as `intractable`, therefore `people today have access to a large ocean of valuable information related to almost any subjects that they are interested in from the online search engine`.  `Under this circumstance, the fact that it is much easier to become an educated person today is not a surprise.`
